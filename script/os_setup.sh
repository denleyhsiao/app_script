...
OS_BASE_FILE=os_base.sh
OS_BASE_SOURCE_FILE=${RAW_GITHUB_PREFIX}/${GITHUB_USER}/${SCRIPT_REPO}/master/script/${OS_BASE_FILE}
OS_BASE_TARGET_FILE=${TEMP_PATH}/${OS_BASE_FILE}
download_file_if_not_exist ${OS_BASE_SOURCE_FILE} ${OS_BASE_TARGET_FILE}
sudo chmod a+x ${OS_BASE_TARGET_FILE}
